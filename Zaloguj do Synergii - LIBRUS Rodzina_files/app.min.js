...
/*
   ...
   Create error message on OAuth login page
   
   Author:
   Wojciech Matusiak <wojciech.matusiak[at]librus.pl>

   Parameters:
   string message - dom representation of element witch send event
...
/*
   ...
   Create notice message on OAuth login page
...
var isInAppLibrusBrowser = function ()
{
    return (navigator.userAgent.indexOf('LibrusMobileApp') !== -1);
};
...
var notifyResizing = function()
{
    if (typeof parentUrlToNotify != 'undefined') {
        var parentDomainToNotify = getDomainFromUrl(parentUrlToNotify);
        postToParent({
            'command': 'resize_ca_iframe',
            'commandPayload': {
                'height': $('body').innerHeight()
            }
        }, parentDomainToNotify);
    }
};
...
var redirectToPortalIfNotInIframe = function (targetUrl)
{
    if(
        self == top
        && targetUrl
...
var breakFrameIfNotAllowedOrigin = function (oauthAllowOrigin)
{
    ...
    if (
        self === top
        || !oauthAllowOrigin
        || oauthAllowOrigin.includes(referrerOrigin)
    ) {
        showIframeContent();
    } else {
